...
int ClientSynch::perform_request(const std::string &_server)
{
    int retour = 1;
...
int ClientSynch::handle_request_for_POST(const std::string& server, const std::string& path, const std::string& xwwwformcoded)
{
